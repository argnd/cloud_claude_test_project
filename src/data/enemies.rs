...
impl EnemyId {
    pub fn def(self) -> &'static EnemyDef {
        ...
        match self {
            ...
            E::Phantom => &const { D { name: "Phantom", sprite: Sprite::Phantom, shape: shape(0.9, 0.7, 1.6, 1.2, 1.3, 1.1), affinities: &[(Physical, Resist), (Light, Weak), (Shadow, Immune)], skills: &[(K::SoulTouch, 3), (K::Wail, 1)], drops: &[(ItemId::Ether, 12)], reward: 1.2, floors: (6, 9), size: 2.8, boss: false } },
